...
public class GEngine extends Drawable {
    String direction;
    public GEngine(int x, int y, String dir, boolean boom) {
        super(x, y);
        direction = dir;
        ...
        try {
            if(!boom) {
                ...
                if (dir.equals("23") || dir.equals("10"))
                    rotate(45);
                else if (dir.equals("13") || dir.equals("3"))
                    rotate(90);
                else if (dir.equals("03") || dir.equals("12"))
                    rotate(135);
                else if (dir.equals("02") || dir.equals("2"))
                    rotate(180);
                else if (dir.equals("01") || dir.equals("32"))
                    rotate(225);
                else if (dir.equals("31") || dir.equals("1"))
                    rotate(270);
